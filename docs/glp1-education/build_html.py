#!/usr/bin/env python3
"""
Build a styled, printable HTML from glp1_patient_guide.md.

Usage:
    python3 build_html.py
    python3 build_html.py <input.md> <output.html>
Produces:
    glp1_patient_guide.html  (open in browser, Ctrl+P -> Save as PDF)
"""
...
SRC = BASE_DIR / "glp1_patient_guide.md"
DST = BASE_DIR / "glp1_patient_guide.html"
...
COVER_HTML = """
<div class="cover">
  <div class="badge">Patient Education</div>
  <h1>GLP-1 Receptor Agonists: How They Manage Blood Sugar and Help With Weight Loss</h1>
  <h2>A patient-education guide</h2>
  <div class="meta">
    Plain-language overview &middot; Evidence-based &middot; Cited primary sources<br/>
...
<title>GLP-1 Receptor Agonists: How They Manage Blood Sugar and Help With Weight Loss</title>
<style>{CSS}</style>
</head>
<body>
<div class="wrap">
